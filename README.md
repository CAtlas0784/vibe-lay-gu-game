...
| **Map Fog Removal & Precise Teleport (ลบหมอก & วาร์ป)** | 🟡 รอก่อน / กำลังหาวิธี | ระบบวาร์ป 2 คลิกบนแผนที่ทำงานได้สมบูรณ์ ไม่ตกแมพ (0, 0, 0) ส่วนระบบปลดหมอกบนแผนที่ (Map Fog) ยังอยู่ระหว่างหาวิธีการเปิดถาวร |
...
| **Retail Game Switches & Unlimited Currency** | 🟣 เอ๋อ / มีข้อจำกัด | ปลดล็อกฟังก์ชันและให้เงิน/ไอเทมเริ่มต้น แต่ยังมีอาการเอ๋อในบางระบบร้านค้าและเมนูกาชา |
