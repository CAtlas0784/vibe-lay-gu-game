...
| :--- | :---: | :--- |
| **Combat & Skill System (ระบบต่อสู้และสกิล)** | 🟡 กำลังพัฒนา / มีข้อจำกัด / บัค | ผูก Weapon Profile, Basic Attack Combo, Heavy Attack, Active Skill, Dodge, Unique Ultimate Skill และ Fight Resources (SP/Energy) ให้กับตัวละครทุกตัว แต่ยังมีบัคแอนิเมชันสกิลกดรัวขัดจังหวะตัวเองได้ |
...
| **Character Switching & World Entities (สลับตัวละคร & ตัวเก่ายังอยู่)** | 🟡 กำลังทดสอบ | สลับตัวละครได้ในฉากเดียวกัน พิกัดต่อเนื่อง โดยคงตัวละครเดิมไว้ในฉากไม่ Despawn เพื่อทดสอบระบบ Interact/อุ้ม และซ่อนปุ่ม F บนหัวตัวละครที่กำลังเล่นอยู่ (กำลังทดสอบในเกม) |
...
| **Map Fog Removal & Precise Teleport (ลบหมอก & วาร์ป)** | 🟡 กำลังทดสอบ | ปิดหมอกแมพถาวร (`FogMap = false`, `ShowAllMapArea = true`) และแก้ระบบ Alt+Click วาร์ปในแผนที่ให้ใช้ความสูงพื้นผิว ไม่ตกแมพหล่นไปที่ (0, 0, 0) (กำลังทดสอบในเกม) |
...
| **Outfit Toggle (ปุ่มลัดถอดชุดเหลือร่างต้น)** | 🟡 กำลังทดสอบ | กดปุ่ม **F8** ในเกม หรือกดผ่าน Web Debug Panel เพื่อสลับถอดเสื้อผ้าและเครื่องประดับทั้งหมดเหลือเพียงร่างเปล่า (Base Body) ตามต้องการ (กำลังทดสอบในเกม) |
...
| **Monster Spawning (เสกมอนเตอร์)** | 🟡 กำลังทดสอบ | เสกมอนเตอร์หรือหุ่นซ้อมรบได้ผ่านปุ่ม **F7** ในเกม หรือผ่าน Web Debug Panel พร้อม Toast แจ้งเตือนขึ้นบนหน้าจอ (กำลังทดสอบในเกม) |
