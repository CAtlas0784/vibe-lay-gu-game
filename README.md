...
| **Realtime 3D Cutscenes & Timelines** | 🟢 ใช้งานได้สมบูรณ์ | เล่นคัทซีน Realtime 3D In-Engine ผ่าน Cinemachine และ Timeline ภายในตัวเกมโดยตรง (14 Presets บน Web Debug Panel) ตัดคัทซีนวิดีโอพรีเรนเดอร์ที่ไม่มีไฟล์ออกแล้ว |
| **Taffy Signature Weapon & Combat (塔菲专属武器/技能)** | 🟢 ใช้งานได้สมบูรณ์ | มอเตอร์ไซค์ล้อเดียวของ Taffy เป็นการแปลงสภาพอาวุธค้อนของ Taffy โดยตรง (Active Skill `51935230`) เซิร์ฟเวอร์ผูกสกิลเฉพาะตัวและรองรับ RPC การขับขี่ไว้สมบูรณ์แล้ว |
