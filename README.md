...
| **Character Switching & World Entities (สลับตัวละคร & ตัวเก่ายังอยู่)** | 🟢 ใช้งานได้สมบูรณ์ | สลับตัวละครได้ในฉากเดียวกัน พิกัดต่อเนื่อง โดยคงตัวละครเดิมไว้ในฉากไม่ Despawn เพื่อทดสอบระบบ Interact/อุ้ม และซ่อนปุ่ม F บนหัวตัวละครที่กำลังเล่นอยู่ |
| **Vehicle Boarding (ขึ้นรถด้วยปุ่ม F)** | 🟢 ใช้งานได้สมบูรณ์ | เดินไปใกล้รถแล้วกด F เพื่อขึ้นขับได้ทันทีผ่านระบบ Story Boarding และ Vehicle Drive State โดยตรง |
...
| **Map Fog Removal & Precise Teleport (ลบหมอก & วาร์ป)** | 🟢 ใช้งานได้สมบูรณ์ | ปิดหมอกแมพถาวร (`FogMap = false`, `ShowAllMapArea = true`) และแก้ระบบ Alt+Click วาร์ปในแผนที่ให้ใช้ความสูงพื้นผิว ไม่ตกแมพหล่นไปที่ (0, 0, 0) |
| **Selfie Mode Camera (โหมดเซลฟี่)** | 🟢 ใช้งานได้สมบูรณ์ | แก้หน้าต่าง Adjustment โหลดข้อมูลท่าทางและการแสดงออกครบถ้วน ปรับ FOV มุมกล้องกว้างขึ้น (แก้ความรู้สึกลำบากเหมือนคนแขนสั้น) และออกจากโหมดแล้วท่าทางไม่ค้าง |
| **Outfit Toggle (ปุ่มลัดถอดชุดเหลือร่างต้น)** | 🟢 ใช้งานได้สมบูรณ์ | กดปุ่ม **F8** ในเกม หรือกดผ่าน Web Debug Panel เพื่อสลับถอดเสื้อผ้าและเครื่องประดับทั้งหมดเหลือเพียงร่างเปล่า (Base Body) ตามต้องการ |
| **Housing System (ระบบบ้านและอพาร์ตเมนต์)** | 🟢 ใช้งานได้สมบูรณ์ | ปลดล็อกและเปิดสิทธิ์การเป็นเจ้าของบ้าน/อพาร์ตเมนต์ทั้งหมด (`11200000`, `1001..1005`) สามารถเข้าดูและซื้อได้ |
| **Retail Game Switches & Unlimited Currency** | 🟢 ใช้งานได้สมบูรณ์ | ปลดล็อกฟังก์ชันทั้งหมดในเกม พร้อมตั้งค่าจำนวนเงินและไอเทมในกระเป๋าไม่จำกัด (999,999) สำหรับทดสอบร้านค้าและกาชา |
| **Monster Spawning (เสกมอนเตอร์)** | 🟢 ใช้งานได้สมบูรณ์ | เสกมอนเตอร์หรือหุ่นซ้อมรบได้ทันทีผ่านปุ่ม **F7** ในเกม หรือผ่าน Web Debug Panel พร้อม Toast แจ้งเตือนขึ้นบนหน้าจอ |
