...
| **Realtime 3D Cutscenes & Timelines** | 🟡 กำลังทดสอบ / มีข้อจำกัด / บัค | เล่นคัทซีน Realtime 3D In-Engine ผ่าน Cinemachine และ Timeline ภายในตัวเกมโดยตรง (14 Presets บน Web Debug Panel) ตัดคัทซีนวิดีโอพรีเรนเดอร์ที่ไม่มีไฟล์ออกแล้ว |
